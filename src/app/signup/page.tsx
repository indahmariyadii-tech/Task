        ...
        <div className="glass-card p-10 border-white/10 shadow-2xl backdrop-blur-3xl">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <button 
              ...
              className="flex items-center justify-center gap-3 p-4 bg-white/5 border border-white/5 rounded-2xl hover:bg-white/10 hover:border-white/10 transition-all group"
            >
              ...
              <span className="text-xs font-bold text-white opacity-60 group-hover:opacity-100 transition-opacity">GitHub</span>
            </button>
            <button 
              type="button"
              onClick={() => {
            ...
            >
              ...
              <span className="text-xs font-bold text-white opacity-60 group-hover:opacity-100 transition-opacity">Google</span>
            </button>
          </div>
