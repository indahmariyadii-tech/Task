        ...
        <div className="glass-card p-10 border-white/10 shadow-2xl backdrop-blur-3xl">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="text-sm font-bold text-white opacity-60 group-hover:opacity-100 transition-opacity">GitHub</span>
            </button>
            <button 
              type="button"
            ...
            >
              ...
              <span className="text-sm font-bold text-white opacity-60 group-hover:opacity-100 transition-opacity">Google</span>
            </button>
          </div>
